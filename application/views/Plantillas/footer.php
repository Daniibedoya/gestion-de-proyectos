<footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix text-muted text-sm-center mb-0 px-2">
        <span class="float-md-right d-xs-block d-md-inline-block">Copyright  &copy; 2019 
            <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">PROYECTOS </a>, Todos los derechos reservados. 
        </span>
    </p>
</footer>
...
<script src="<?php echo base_url('app-assets/js/core/acordeon.js'); ?>"></script>